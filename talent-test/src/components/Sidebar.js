...
const handleMenuCLick = (e) => {
   ...
   var element = target.closest(".menu").querySelector('.submenu');
   for (let i = 0; i < elements.length; i++)
   {
    if(elements[i] !== element)
      elements[i].style.display = "";
   }
   if(element.style.display === "" || element.style.display === "hidden")
      element.style.display = "block";
   else if (element.style.display === "block")
         element.style.display = "";

    
   var buttonelements = document.getElementsByClassName("menubutton");
   var buttonelement = target.closest(".menubutton");
   for (let i = 0; i < buttonelements.length; i++)
   {
      if(buttonelements[i] !== buttonelement)
      buttonelements[i].classList.remove("buttonmenu");
   }
...
<div class="relative flex w-full max-w-[18rem] flex-col rounded-xl bg-gray-800 bg-clip-border p-4 text-gray-700 shadow-xl shadow-blue-gray-900/5">
  ...
  <div className="menu">
  <div role="button"  onClick={handleMenuCLick} className="menubutton hover:text-yellow-500 rounded-none hover:bg-black hover:border-l-2 hover:border-yellow-500 flex w-full py-2 leading-tight transition-all rounded-lg outline-none text-start text-white">
  ...
  <div className="menu">
  <div onClick={handleMenuCLick} role="button" className="menubutton hover:text-yellow-500 rounded-none hover:bg-black hover:border-l-2 hover:border-yellow-500 flex w-full py-2 leading-tight transition-all rounded-lg outline-none text-start text-white">
      <div className="px-2 py-1">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" class="size-4">
